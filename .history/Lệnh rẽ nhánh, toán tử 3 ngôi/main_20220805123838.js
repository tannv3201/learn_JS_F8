...
// Nhận về tổng số tiền của khóa học
    ...
    // 
    function filmOfChNoLan(watchList) { // Tìm những bộ phim của Ch Nolan
        var result = watchList.filter(function(film) {
    ...
    function calculateRating(watchList) { 
        var a = filmOfChNoLan(watchList) ;
        var tong = a.reduce(function(total, film){
            return total + new Number(film.imdbRating);
        }, 0);
