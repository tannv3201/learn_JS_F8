...
function handleUpdateCourse(id) {
    var txtNameCourse = document.querySelector('#name-course').textContent;
    console.log(txtNameCourse)

    var txtDescCourse = document.querySelector('#desc-course' + id).textContent;

    document.querySelector('input[name="name"]').value = `${txtNameCourse}`;
    document.querySelector('input[name="description"]').value = `${txtDescCourse}`;
    ...
    var htmls = courses.map(function (course) {
        return `
            <li>
                ...
                <button onclick="handleUpdateCourse(${course.id})">Cập nhật</button>
            </li>
        `
    });
