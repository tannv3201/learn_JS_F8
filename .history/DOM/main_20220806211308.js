...
// Collection
console.log('Cách 1',document.forms['form1'])
console.log('Cách 2',document.forms)
console.log('Cách 3', document.forms.form2)
console.log(document.anchors) // trả về các thẻ a có attribute name=""
