...
// ******************************************************************
// Thêm Element vào trong 1 Element trong DOM
// innerHTML & outerHTML là 2 thuộc tính của ElementNode
// InnerHTML
    var boxElement = document.querySelector('.box-element');
    boxElement.innerHTML = '<h1>Đây là inner HTML</h1>' //Thêm trực tiếp dưới dạng ElementNode, bỏ tag đi sẽ thành innerText
